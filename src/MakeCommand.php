...
namespace Sindria\Homestead;

use Sindria\Homestead\Settings\JsonSettings;
use Sindria\Homestead\Settings\YamlSettings;
use Sindria\Homestead\Traits\GeneratesSlugs;
...
class MakeCommand extends Command
{
    ...
    {
        return (bool) preg_match('/vendor\/sindria\/homestead/', __DIR__);
    }
